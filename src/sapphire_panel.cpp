...
namespace Sapphire
{
    ...
    static const ModuleMap TheModuleMap
    {
        ...
        { "opal", {
            ...
            {"integral_atten",         {   5.160,  100.500}},
            {"integral_cv",            {  15.160,  100.500}},
            {"integral_knob",          {  10.160,   89.500}},
            {"neg_input",              {  10.160,   28.250}},
            {"pos_input",              {  10.160,   16.000}},
            {"proportional_atten",     {   5.160,   63.750}},
            {"proportional_cv",        {  15.160,   63.750}},
            {"proportional_knob",      {  10.160,   52.750}},
            }},
        { "pivot", {
            {"_panel",                 {  20.320,  128.500}},
