...
namespace Sapphire
{
    ...
    static const ModuleMap TheModuleMap
    {
        ...
        { "env", {
            {"_panel",                 {  30.480,  128.500}},
            {"audio_input",            {  15.240,   83.000}},
            {"envelope_output",        {  15.240,   98.500}},
            {"hicut_atten",            {  15.240,   67.500}},
            {"hicut_cv",               {   6.240,   67.500}},
            {"hicut_knob",             {  24.240,   67.500}},
            {"locut_atten",            {  15.240,   52.000}},
            {"locut_cv",               {   6.240,   52.000}},
            {"locut_knob",             {  24.240,   52.000}},
            {"pitch_output",           {  15.240,  114.000}},
            {"speed_atten",            {  15.240,   36.500}},
            {"speed_cv",               {   6.240,   36.500}},
            {"speed_knob",             {  24.240,   36.500}},
            {"thresh_atten",           {  15.240,   21.000}},
            {"thresh_cv",              {   6.240,   21.000}},
            {"thresh_knob",            {  24.240,   21.000}},
            }},
        { "frolic", {
