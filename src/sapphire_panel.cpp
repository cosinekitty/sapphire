...
namespace Sapphire
{
    ...
    static const ModuleMap TheModuleMap
    {
        ...
        { "inloop", {
            {"_panel",                 {  60.960,  128.500}},
            {"audio_left_input",       {  15.240,   91.000}},
            {"audio_right_input",      {  15.240,  101.000}},
            {"clear_button",           {  24.240,   60.500}},
            {"clear_input",            {   6.240,   60.500}},
            {"clock_input",            {  15.240,   74.000}},
            {"env_gain_knob",          {  37.720,  117.000}},
            {"env_left_output",        {  52.720,  112.000}},
            {"env_right_output",       {  52.720,  122.000}},
            {"feedback_atten",         {  15.240,   33.500}},
            {"feedback_cv",            {   6.240,   33.500}},
            {"feedback_knob",          {  24.240,   33.500}},
            {"freeze_button",          {  24.240,   47.000}},
            {"freeze_input",           {   6.240,   47.000}},
            {"gain_atten",             {  45.720,   74.000}},
            {"gain_cv",                {  36.720,   74.000}},
            {"gain_knob",              {  54.720,   74.000}},
            {"insert_button",          {  57.960,    5.000}},
            {"mix_atten",              {  45.720,   60.500}},
            {"mix_cv",                 {  36.720,   60.500}},
            {"mix_knob",               {  54.720,   60.500}},
            {"pan_atten",              {  45.720,   47.000}},
            {"pan_cv",                 {  36.720,   47.000}},
            {"pan_knob",               {  54.720,   47.000}},
            {"return_left_input",      {  52.720,   91.000}},
            {"return_right_input",     {  52.720,  101.000}},
            {"reverse_button",         {  54.720,   33.500}},
            {"reverse_input",          {  36.720,   33.500}},
            {"send_left_output",       {  38.720,   91.000}},
            {"send_right_output",      {  38.720,  101.000}},
            {"time_atten",             {  45.720,   20.000}},
            {"time_cv",                {  36.720,   20.000}},
            {"time_knob",              {  54.720,   20.000}},
            }},
        { "lark", {
            {"_panel",                 {  20.320,  128.500}},
            {"chaos_atten",            {   5.160,   68.000}},
        ...
        { "loop", {
            {"_panel",                 {  30.480,  128.500}},
            {"env_gain_knob",          {   7.240,  117.000}},
            {"env_left_output",        {  22.240,  112.000}},
            {"env_right_output",       {  22.240,  122.000}},
            {"gain_atten",             {  15.240,   74.000}},
            {"gain_cv",                {   6.240,   74.000}},
            {"gain_knob",              {  24.240,   74.000}},
            {"insert_button",          {  27.480,    5.000}},
            {"mix_atten",              {  15.240,   60.500}},
            {"mix_cv",                 {   6.240,   60.500}},
            {"mix_knob",               {  24.240,   60.500}},
            {"pan_atten",              {  15.240,   47.000}},
            {"pan_cv",                 {   6.240,   47.000}},
            {"pan_knob",               {  24.240,   47.000}},
            {"return_left_input",      {  22.240,   91.000}},
            {"return_right_input",     {  22.240,  101.000}},
            {"reverse_button",         {  24.240,   33.500}},
            {"reverse_input",          {   6.240,   33.500}},
            {"send_left_output",       {   8.240,   91.000}},
            {"send_right_output",      {   8.240,  101.000}},
            {"time_atten",             {  15.240,   20.000}},
            {"time_cv",                {   6.240,   20.000}},
            {"time_knob",              {  24.240,   20.000}},
            }},
        { "nucleus", {
