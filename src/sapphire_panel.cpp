...
namespace Sapphire
{
    ...
    static const ModuleMap TheModuleMap
    {
        ...
        { "inloop", {
            ...
            {"clear_button",           {  24.240,   51.000}},
            {"clear_input",            {   6.240,   51.000}},
            {"clock_input",            {  15.240,   72.000}},
            {"env_gain_knob",          {  37.720,  117.000}},
            {"env_left_output",        {  52.720,  112.000}},
            {"env_right_output",       {  52.720,  122.000}},
            {"feedback_atten",         {  15.240,   23.000}},
            {"feedback_cv",            {   6.240,   23.000}},
            {"feedback_knob",          {  24.240,   23.000}},
        ...
        { "outloop", {
            ...
            {"global_mix_atten",       {   5.160,   34.000}},
            {"global_mix_cv",          {  15.160,   34.000}},
            {"global_mix_knob",        {  10.160,   23.000}},
            }},
        { "pivot", {
            {"_panel",                 {  20.320,  128.500}},
