...
namespace Sapphire
{
    ...
    static const ModuleMap TheModuleMap
    {
        ...
        { "opal", {
            ...
            {"enable_button",          {  21.740,  100.000}},
            {"enable_input",           {   8.740,  100.000}},
            {"gate_output",            {  21.740,  114.000}},
            {"hicut_atten",            {  15.240,   58.000}},
            {"hicut_cv",               {   6.240,   58.000}},
            {"hicut_knob",             {  24.240,   58.000}},
            {"integral_atten",         {  15.240,   44.000}},
            {"integral_cv",            {   6.240,   44.000}},
            {"integral_knob",          {  24.240,   44.000}},
            {"max_knob",               {  21.740,   86.000}},
            {"min_knob",               {   8.740,   86.000}},
            {"neg_input",              {  21.740,   16.000}},
            {"pos_input",              {   8.740,   16.000}},
            {"proportional_atten",     {  15.240,   30.000}},
            {"proportional_cv",        {   6.240,   30.000}},
            {"proportional_knob",      {  24.240,   30.000}},
            }},
        { "pivot", {
            {"_panel",                 {  20.320,  128.500}},
