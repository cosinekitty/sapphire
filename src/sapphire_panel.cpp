...
namespace Sapphire
{
    ...
    static const ModuleMap TheModuleMap
    {
        ...
        { "opal", {
            ...
            {"integral_atten",         {   5.160,   88.250}},
            {"integral_cv",            {  15.160,   88.250}},
            {"integral_knob",          {  10.160,   77.250}},
            {"neg_input",              {  10.160,   28.250}},
            {"pos_input",              {  10.160,   16.000}},
            {"proportional_atten",     {   5.160,   59.462}},
            {"proportional_cv",        {  15.160,   59.462}},
            {"proportional_knob",      {  10.160,   48.462}},
            }},
        { "pivot", {
            {"_panel",                 {  20.320,  128.500}},
