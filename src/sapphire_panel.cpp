...
namespace Sapphire
{
    ...
    static const ModuleMap TheModuleMap
    {
        ...
        { "inloop", {
            ...
            {"clear_button",           {  24.240,   67.000}},
            {"clear_input",            {   6.240,   67.000}},
            {"clock_input",            {  15.240,   22.000}},
            {"feedback_atten",         {  15.240,   37.000}},
            {"feedback_cv",            {   6.240,   37.000}},
            {"feedback_knob",          {  24.240,   37.000}},
            {"freeze_button",          {  24.240,   52.000}},
            {"freeze_input",           {   6.240,   52.000}},
            {"gain_atten",             {  45.720,   82.000}},
            {"gain_cv",                {  36.720,   82.000}},
            {"gain_knob",              {  54.720,   82.000}},
            {"insert_button",          {  57.960,    6.000}},
            {"mix_atten",              {  45.720,   67.000}},
            {"mix_cv",                 {  36.720,   67.000}},
            {"mix_knob",               {  54.720,   67.000}},
            {"pan_atten",              {  45.720,   52.000}},
            {"pan_cv",                 {  36.720,   52.000}},
            {"pan_knob",               {  54.720,   52.000}},
            {"return_left_input",      {  52.720,  100.000}},
            {"return_right_input",     {  52.720,  110.000}},
            {"reverse_button",         {  54.720,   37.000}},
            {"reverse_input",          {  36.720,   37.000}},
            {"send_left_output",       {  38.720,  100.000}},
            {"send_right_output",      {  38.720,  110.000}},
            {"time_atten",             {  45.720,   22.000}},
            {"time_cv",                {  36.720,   22.000}},
            {"time_knob",              {  54.720,   22.000}},
            }},
        { "lark", {
            {"_panel",                 {  20.320,  128.500}},
            {"chaos_atten",            {   5.160,   68.000}},
        ...
        { "loop", {
            {"_panel",                 {  30.480,  128.500}},
            {"gain_atten",             {  15.240,   82.000}},
            {"gain_cv",                {   6.240,   82.000}},
            {"gain_knob",              {  24.240,   82.000}},
            {"insert_button",          {  27.480,    6.000}},
            {"mix_atten",              {  15.240,   67.000}},
            {"mix_cv",                 {   6.240,   67.000}},
            {"mix_knob",               {  24.240,   67.000}},
            {"pan_atten",              {  15.240,   52.000}},
            {"pan_cv",                 {   6.240,   52.000}},
            {"pan_knob",               {  24.240,   52.000}},
            {"return_left_input",      {  22.240,  100.000}},
            {"return_right_input",     {  22.240,  110.000}},
            {"reverse_button",         {  24.240,   37.000}},
            {"reverse_input",          {   6.240,   37.000}},
            {"send_left_output",       {   8.240,  100.000}},
            {"send_right_output",      {   8.240,  110.000}},
            {"time_atten",             {  15.240,   22.000}},
            {"time_cv",                {   6.240,   22.000}},
            {"time_knob",              {  24.240,   22.000}},
            }},
        { "nucleus", {
