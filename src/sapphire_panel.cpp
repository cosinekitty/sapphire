...
namespace Sapphire
{
    ...
    static const ModuleMap TheModuleMap
    {
        ...
        { "empath_filter", {
            {"_panel",                 {  30.480,  128.500}},
            {"audio_left_output",      {  15.240,  102.000}},
            {"audio_right_output",     {  15.240,  112.000}},
            {"casc_atten",             {  15.240,   75.000}},
            {"casc_cv",                {   6.240,   75.000}},
            {"casc_knob",              {  24.240,   75.000}},
            {"freq_atten",             {  15.240,   47.500}},
            {"freq_cv",                {   6.240,   47.500}},
            {"freq_knob",              {  24.240,   47.500}},
            {"insert_button",          {  27.480,    4.500}},
            {"mode_button",            {  24.240,   33.750}},
            {"mode_input",             {   6.240,   33.750}},
            {"mode_label",             {  15.240,   33.750}},
            {"output_label_left",      {  21.740,  102.000}},
            {"output_label_right",     {  21.740,  112.000}},
            {"remove_button",          {   3.000,  123.500}},
            {"res_atten",              {  15.240,   61.250}},
            {"res_cv",                 {   6.240,   61.250}},
            {"res_knob",               {  24.240,   61.250}},
            {"source_button",          {  24.240,   20.000}},
            {"source_input",           {   6.240,   20.000}},
            {"source_label",           {  15.240,   20.000}},
            }},
        { "empath_input", {
            {"_panel",                 {  40.640,  128.500}},
            {"audio_left_input",       {  16.320,  102.000}},
            {"audio_right_input",      {  16.320,  112.000}},
            {"channel_mode_button",    {   9.820,  107.000}},
            {"input_label_left",       {   9.820,  102.000}},
            {"input_label_right",      {   9.820,  112.000}},
            {"insert_button",          {  37.640,    4.500}},
            }},
        { "empath_output", {
            {"_panel",                 {  20.320,  128.500}},
            {"audio_left_output",      {  10.160,  102.000}},
            {"audio_right_output",     {  10.160,  112.000}},
            {"global_level_atten",     {   5.160,   71.250}},
            {"global_level_cv",        {  15.160,   71.250}},
            {"global_level_knob",      {  10.160,   60.250}},
            {"global_mix_atten",       {   5.160,   37.325}},
            {"global_mix_cv",          {  15.160,   37.325}},
            {"global_mix_knob",        {  10.160,   26.325}},
            {"output_label_left",      {  16.660,  102.000}},
            {"output_label_right",     {  16.660,  112.000}},
            }},
        { "env", {
            {"_panel",                 {  30.480,  128.500}},
