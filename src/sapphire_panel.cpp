...
namespace Sapphire
{
    ...
    static const ModuleMap TheModuleMap
    {
        ...
        { "inloop", {
            ...
            {"env_gain_knob",          {  52.720,  117.000}},
            {"env_left_output",        {  38.720,  112.000}},
            {"env_right_output",       {  38.720,  122.000}},
        ...
        { "loop", {
            {"_panel",                 {  30.480,  128.500}},
            {"env_gain_knob",          {  22.240,  117.000}},
            {"env_left_output",        {   8.240,  112.000}},
            {"env_right_output",       {   8.240,  122.000}},
