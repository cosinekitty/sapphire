...
namespace Sapphire
{
    ...
    static const ModuleMap TheModuleMap
    {
        ...
        { "opal", {
            ...
            {"integral_atten",         {  10.240,   88.250}},
            {"integral_cv",            {  20.240,   88.250}},
            {"integral_knob",          {  15.240,   77.250}},
            {"neg_input",              {  15.240,   28.250}},
            {"pos_input",              {  15.240,   16.000}},
            {"proportional_atten",     {  10.240,   59.462}},
            {"proportional_cv",        {  20.240,   59.462}},
            {"proportional_knob",      {  15.240,   48.462}},
            }},
        { "pivot", {
            {"_panel",                 {  20.320,  128.500}},
