    ...
    private:
        ModuleMap modmap
        {
            ...
            { "gravy", {
                ...
                {"audio_right_input",      {  21.240,   22.000}},
                {"audio_right_output",     {  21.240,  114.000}},
                {"drive_atten",            {  15.240,   68.000}},
                {"drive_cv",               {   6.240,   68.000}},
                {"drive_knob",             {  24.240,   68.000}},
                {"frequency_atten",        {  15.240,   37.333}},
                {"frequency_cv",           {   6.240,   37.333}},
                {"frequency_knob",         {  24.240,   37.333}},
                {"gain_atten",             {  15.240,   98.667}},
                {"gain_cv",                {   6.240,   98.667}},
                {"gain_knob",              {  24.240,   98.667}},
                {"mix_atten",              {  15.240,   83.333}},
                {"mix_cv",                 {   6.240,   83.333}},
                {"mix_knob",               {  24.240,   83.333}},
