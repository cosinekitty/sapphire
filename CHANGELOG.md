...
<td align="left">
    <ul>
        ...
        <li>Multiple <a href="doc/Hiss.md">Hiss</a> modules in a patch were generating the same sequence. Now initialize with 64-bits of entropy so they are all different.</li>
    </ul>
</td>
</tr>
